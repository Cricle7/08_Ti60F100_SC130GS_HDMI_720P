...
vsim -t ps +notimingchecks -gui -voptargs="+acc" work.ping_pong_ram_tb
...
# add wave -position insertpoint sim:/union_find_tb/*
# add wave -position insertpoint sim:/union_find_tb/dut/*
#do wave.do
#Run simulation
# run -all
